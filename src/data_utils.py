...
def main():
    ...
    print("\n" + "="*80)
    print("DEEPNABIND-MM DATASET PREPARATION (SHARDED MODE)")
    print("Using pre-downloaded FASTA files, structures, and sharded ESM-2 embeddings")
    print("="*80)
    print("\nLabel scheme: 0 = non-NABP, 1 = RBP, 2 = DBP")
